  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-white">
        ...
        <motion.button
          className="mt-6 px-6 py-3 bg-purple-600 text-white font-semibold text-lg rounded-full shadow-md"
          whileHover={{
            scale: 1.1,
            boxShadow: "0px 0px 15px rgba(128, 90, 213, 1)", // Purple glow effect
          }}
          whileTap={{ scale: 0.95 }}
          onClick={() => {
