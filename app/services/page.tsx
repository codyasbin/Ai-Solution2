  ...
  return (
    ...
    >
      <div>
        ...
        >
          Our AI<span className="text-purple-300"> Powered Services</span>
        </motion.h1>
        <motion.p
      ...
      <motion.section
        className="relative py-20 bg-purple-800 text-white"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
        variants={{
      ...
      >
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="flex justify-center gap-16">
            {/* Step 1 */}
            <motion.div
              className="flex flex-col items-center bg-purple-700 p-8 rounded-lg shadow-lg w-64"
              whileHover={{ scale: 1.05 }}
            >
              <motion.div
                className="w-16 h-16 mb-4 bg-purple-600 text-white rounded-full flex items-center justify-center"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
